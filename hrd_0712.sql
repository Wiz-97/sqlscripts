...
values(member_seq.nextval, '김행복', '010-1111-2222', '서울시 동대문구 휘경1동', '2015-12-02', 'A', '01');
insert into member_tbl_02
values(member_seq.nextval, '이축복', '010-1111-3333', '서울시 동대문구 휘경2동', '2015-12-06', 'B', '01');
insert into member_tbl_02
