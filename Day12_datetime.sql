...
CREATE TABLE tbl_date(
	...
	ccol timestamp(9) ,			-- 9는 소수점 이하 9번째 자리까지 표시하겠다는 의미
...
VALUES ('2022-10-11','2022-10-12');		--DATE, timestamp 차이 X

-- 내일 시험에서 timestamp 타입은 date 타입과 똑같이 코딩하면 됨
-- 날짜 형식은 문자열 'yyyy-MM-dd'와 자동캐스팅이 됨
-- date와 timestamp 모두 to_char 함수는 동일하게 사용
